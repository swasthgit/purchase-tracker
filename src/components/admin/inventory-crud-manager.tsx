...
const InventoryCrudManager: React.FC = () => {
  ...
  return ( <
    ...
    div >
    <
    Input placeholder = "Search by clinic or item name..."
    value = {
      searchTerm
    }
    onChange = {
    ...
    /> {
      ...
      Input id = "approx price per unit"
      name = "approx price per unit"
      type = "number"
      step = "0.01"
      value = {
        formData["approx price per unit"]
      }
      onChange = {
        handleInputChange
      }
      ...
      onOpenChange = {
        (open) => !open && setItemToRemove(null)
      } >
      <
      AlertDialogContent >
      <
